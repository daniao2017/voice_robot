...
const char* fileName="/home/danoao/Music/voice.wav";
const char* playPath="play /home/danoao/Music/voice.wav";
...
{
        int ret=MSP_SUCCESS;
    const char* login_params="appid = 5e607847, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
    /*
    * rdn:           合成音频数字发音方式
    ...
    *
    */
    const char* session_begin_params = "voice_name = xiao, text_encoding = utf8, sample_rate = 16000, speed = 60, volume = 60, pitch = 50, rdn = 0";
    /* const char* filename             = "tts_sample.wav"; //合成的语音文件名称
    const char* text                 = "666"; //合成文本 */
...
{
const char* start = "小刘同学是一个集语音交互，语意理解，发送邮件为一体的交互性机器人。作者小刘同学";
